...
public class QuieremeDialogFragment extends DialogFragment {
    ...
    public QuieremeDialogFragment() {
    }

    public static QuieremeDialogFragment newInstance(String title, String fullSnippet) {
        QuieremeDialogFragment fragment = new QuieremeDialogFragment();
        Bundle b = new Bundle();
