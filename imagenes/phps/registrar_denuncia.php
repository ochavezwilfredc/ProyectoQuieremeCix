...
//-------------Insertar Mascota ---------------------
   ...
   /* if (mysqli_query($con, $sql_insertarMas)) {
        echo 'Mascota registrada correctamente';
    } else {
        echo 'No se puede agregar la mascota';
    }*/
...
//--------------------fin de insercción de mascota ----------
    ...
    $sql_insertaArt = "INSERT INTO `articulo`( 
                                        ...
                                        `idmascota`, 
                                        `idpersona`)
             VALUES ('$titulo','$lugar','$latitud','$longitud','$descripcion',0,1,'$id_mascota','$id_persona')";
...
//********************************************************************
    ...
    if (mysqli_query($con, $sql_insertarDetArt)) {
        ...
        echo 'No se puede agregar la denuncia';
    }
